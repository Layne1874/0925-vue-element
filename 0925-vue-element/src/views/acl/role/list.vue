		...
		<el-card class="demo-card-inline">
			...
			<el-table border stripe style="width: 960px" v-loading="listLoading" :data="roles"
				...
				<el-table-column label="操作" width="300" align="center">
					<template slot-scope="{row}">
						<hint-button size="mini" type="info" icon="el-icon-info" title="分配权限"
							@click="toroleAuth(row)" />
						<hint-button size="mini" type="primary" icon="el-icon-check" title="确定" @click="updateRole(row)"
							v-if="row.edit" />
						<hint-button size="mini" type="primary" icon="el-icon-edit" title="修改角色" @click="row.edit= true"
							v-if="!row.edit" />

						<hint-button size="mini" type="danger" icon="el-icon-delete" title="删除角色"
			...
			<el-pagination :current-page="page" :total="total" :page-size="limit"
				...
				layout="prev, pager, next, jumper, ->, sizes, total" @current-change="getRoles"
